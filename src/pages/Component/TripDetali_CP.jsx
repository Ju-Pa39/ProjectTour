...
// const TripDetail_CP = () => {
//   const trip = tripStore((state) => state.upcomingTrip);
...
//       <h1 className="text-3xl font-bold mb-6">ทริปคลุกฝุ่นทัวร์3333</h1>
...
const TripDetail_CP = () => {
  ...
  return (
    <div className="flex flex-col items-center p-8">
      <h1 className="text-3xl font-bold mb-6 text-red-600">กรุณากดเลือกทริปไฟไหม้</h1>
    </div>
  );
};
